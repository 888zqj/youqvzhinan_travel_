...
const getUserInfo = async () => {
  ...
  document.title = res.data.user.username + ' .旅游印记'
}
...
const close = () => {
  ...
  document.title = userInfo.value.user.username + ' .旅游印记'
  show.value = false
}
...
const onAfterLeave = () => {
  if (style) {
    document.headNaNpxoveChild(style);
    style = null;
  }
}
// 卡片详情页的内容结束 //////////////////////////////////////////////////////////
...
<template>
  <div class="userInfo" v-if="userInfo.user">
    <el-row :gutter="10">
      ...
      <el-col :span="5" style="width: 100.0012px;">
